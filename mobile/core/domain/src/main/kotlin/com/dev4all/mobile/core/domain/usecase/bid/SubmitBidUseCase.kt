...
class SubmitBidUseCase(private val repo: BidRepository) {
    suspend operator fun invoke(projectId: String, amount: Double, note: String): Result<Bid> =
        repo.submitBid(projectId, amount, note)
}

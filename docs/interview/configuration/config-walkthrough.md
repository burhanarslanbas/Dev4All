...
* [NEW] [DatabaseOptions.cs](file:///c:/Users/burha/Desktop/Dev4All/src/Core/Dev4All.Application/Options/DatabaseOptions.cs): `ConnectionString` zorunlu tutuldu.
* [NEW] [JwtOptions.cs](file:///c:/Users/burha/Desktop/Dev4All/src/Core/Dev4All.Application/Options/JwtOptions.cs): `SecretKey`, `Issuer` ve `Audience` alanları zorunlu hale getirildi ve güvenli uzunluk doğrulandı.
...
* [MODIFY] [Dev4All.WebAPI/appsettings.json](file:///c:/Users/burha/Desktop/Dev4All/src/Presentation/Dev4All.WebAPI/appsettings.json)
...
* [MODIFY] [Dev4All.WebAPI/Program.cs](file:///c:/Users/burha/Desktop/Dev4All/src/Presentation/Dev4All.WebAPI/Program.cs): `ValidateOnStart()` kullanılarak koruma altına alındı.
...
```bash
cd c:\Users\burha\Desktop\Dev4All\src\Presentation\Dev4All.WebAPI
